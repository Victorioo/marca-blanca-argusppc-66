  ...
  return <section className="py-20 px-4 relative">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">Somos el motor invisible que impulsa tu agencia para que siempre destaques frente a tus clientes y des mejores resultados.</p>
          <div className="inline-block bg-primary/20 rounded-full px-6 py-3 border border-primary/30">
            <p className="text-primary font-semibold">Tú compartes el briefing, nosotros ejecutamos en marca blanca</p>
          </div>
        </div>
