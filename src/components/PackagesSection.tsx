      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-primary font-semibold">
            Desde $450 al mes. Estos paquetes ya han ayudado a agencias a aumentar sus fees hasta un 30% sin sumar equipo interno.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {packages.map((pkg, index) => (
            <div key={index} className={`relative ${pkg.popular ? 'transform scale-105' : ''}`}>
              ...
              <div className={`card-shadow backdrop-blur-sm rounded-2xl p-8 border h-full ${
                pkg.popular 
