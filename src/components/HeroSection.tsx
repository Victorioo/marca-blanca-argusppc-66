...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center px-4 hero-gradient">
      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">Ayudamos a Agencias de Marketing a escalar su oferta con Growth Marketing y Paid Media, aumentando el valor de su fee y entregando resultados tangibles a sus clientes, sin ampliar estructura ni asumir costos fijos, gracias  a nuestro soporte de  </p>
